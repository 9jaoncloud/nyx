    ...
    var sections = [
        {
            ...
            links: [
                ...
                { href: 'mobile-frontier.html', label: '📱 Mobile Frontier (Solving All Failure Modes)' },
                { href: 'systems-frontier.html', label: '⚡ Systems Frontier (Hardware, LoRa, OS & NyxOS)' },
                { href: 'learn/index.html', label: '🎓 Interactive Academy (4 Tracks)' },
        ...
        },
        {
            ...
            links: [
                ...
                { href: 'security-limits.html', label: '🛡️ Security Limits & Formal Guarantees' },
                { href: 'abuse-patterns.html', label: '🔍 Living Abuse Patterns & Defense' },

...
Window window = Window_new(1024LL, 720LL, rt_string_from("Nyx Material 3 Interactive Studio"));
...
CardWidget left_card = (CardWidget){.title = rt_string_from("System Configuration Controls"), .subtitle = rt_string_from("Interactive switches, sliders, and form components"), .variant = (CardVariant){ .tag = TAG_CardVariant_Elevated }, .width = 480, .height = 600, .elevation = 2};
...
ButtonWidget btn_save = (ButtonWidget){.label = rt_string_from("Save Settings"), .variant = (ButtonVariant){ .tag = TAG_ButtonVariant_Filled }, .width = 160, .height = 40};
MaterialRenderer_draw_button(&(renderer), (&(canvas)), (&(btn_save)), 48, 615);
ButtonWidget btn_discard = (ButtonWidget){.label = rt_string_from("Discard Changes"), .variant = (ButtonVariant){ .tag = TAG_ButtonVariant_Outlined }, .width = 160, .height = 40};
MaterialRenderer_draw_button(&(renderer), (&(canvas)), (&(btn_discard)), 220, 615);
CardWidget right_card = (CardWidget){.title = rt_string_from("Live Runtime Telemetry"), .subtitle = rt_string_from("Real-time thread & buffer metrics"), .variant = (CardVariant){ .tag = TAG_CardVariant_Outlined }, .width = 480, .height = 600, .elevation = 0};
MaterialRenderer_draw_card(&(renderer), (&(canvas)), (&(right_card)), 520, 88);
BadgeWidget badge_opt = (BadgeWidget){.text = rt_string_from("ACTIVE 240Hz"), .bg_color = Color_hex(4279983648LL), .text_color = Color_hex(4291356361LL)};
...
CardWidget sub_card = (CardWidget){.title = rt_string_from("Autonomous Nursery Worker"), .subtitle = rt_string_from("32 nursery threads responding to lock-free channels"), .variant = (CardVariant){ .tag = TAG_CardVariant_Filled }, .width = 432, .height = 140, .elevation = 0};
MaterialRenderer_draw_card(&(renderer), (&(canvas)), (&(sub_card)), 544, 360);
ButtonWidget btn_action = (ButtonWidget){.label = rt_string_from("Inspect Thread Dumps"), .variant = (ButtonVariant){ .tag = TAG_ButtonVariant_Tonal }, .width = 200, .height = 38};
...
int mdown = Window_is_mouse_down(&(window));
